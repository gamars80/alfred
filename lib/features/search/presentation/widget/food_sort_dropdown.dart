...
class FoodSortDropdown extends StatefulWidget {
  final void Function(String sortBy, String sortDir) onChanged;

  const FoodSortDropdown({super.key, required this.onChanged});

  @override
  State<FoodSortDropdown> createState() => _FoodSortDropdownState();
}

class _FoodSortDropdownState extends State<FoodSortDropdown> {
