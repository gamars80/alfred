...
class FoodIngredientReviewListScreen extends StatefulWidget {
  ...
  const FoodIngredientReviewListScreen({
    super.key,
    required this.ingredient,
  });

  @override
  State<FoodIngredientReviewListScreen> createState() => _FoodIngredientReviewListScreenState();
}

class _FoodIngredientReviewListScreenState extends State<FoodIngredientReviewListScreen> {
