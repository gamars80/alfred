...
class BeautyResult {
  ...
  BeautyResult({required this.communityPosts, required this.events, required this.youtubeVideos});
}
...
class BeautyApi {
  ...
  Future<BeautyResult> fetchBeautyData(String query) async {
    try {
      ...
      return BeautyResult(communityPosts: posts, events: events, youtubeVideos: videos);
