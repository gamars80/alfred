...
class CareReviewSearchScreen extends StatefulWidget {
  const CareReviewSearchScreen({super.key});

  @override
  State<CareReviewSearchScreen> createState() => _CareReviewSearchScreenState();
}

class _CareReviewSearchScreenState extends State<CareReviewSearchScreen> {
  final _textController = TextEditingController();
  SharedPreferences? _prefs;
  List<String> _recentSearches = [];
  static const _maxRecentSearches = 10;
  static const _prefsKey = 'care_review_recent_searches';
